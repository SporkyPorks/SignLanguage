...
BOX_W, BOX_H = 700, 700  # central detection box
...
def is_j_motion(pinky_history):
    ...
    return dx < -20 and dy > 20 and total_angle > 1.0  # ~57 degrees curvature
